...
export default function Footer({ className }: FooterProps) {
  ...
  return (
    <footer className={cn('border-t border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900', className)}>
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0">
          {/* Contact Info */}
          <div className="text-center md:text-left">
            <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Get In Touch</h3>
            <p className="mb-1 text-gray-600 dark:text-gray-400">{SITE_CONFIG.author}</p>
            <a
              href={`mailto:${SITE_CONFIG.social.linkedin?.split('/').pop() || 'contact@example.com'}`}
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 dark:border-gray-700">
          <div className="flex flex-col items-center justify-between text-sm text-gray-600 md:flex-row dark:text-gray-400">
            ...
            <p className="mt-2 md:mt-0">Built with Next.js, TypeScript, and Tailwind CSS</p>
          </div>
        </div>
      </div>
    </footer>
